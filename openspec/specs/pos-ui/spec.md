...
### Requirement: Cart Clears On Confirmed Sale Or Explicit Empty Action (PD-9)
...
1. **POS catalog query shape** — whether the catalog reuses
   ...
   shape.
2. **Wire-level mechanism for the price-mismatch re-confirmation** (e.g., a confirm
...
3. **`localStorage` versioning/resilience beyond "don't crash"** — whether an incompatible
