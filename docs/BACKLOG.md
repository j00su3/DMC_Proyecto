...
| 3 | Gestión de usuarios | CRUD de usuarios y roles por el encargado; 403 a depósito; baja lógica de usuario; alta con contraseña temporal + cambio obligatorio en el primer ingreso; guarda que impide desactivar o degradar al último encargado activo | #2, #2.1, #2.2 | 🔄 En curso — propuesta escrita |
